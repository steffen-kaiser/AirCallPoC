 ...
 router.post('/aircall/calls', (req, res) => {
    const request_options = {
      ...
      data: {
       ...
       started_at: new Date(req.body.data.started_at),
       answered_at: req.body.data.answered_at ? new Date(req.body.data.answered_at) : null,
       ended_at: req.body.data.ended_at ? new Date(req.body.data.ended_at) : null,
